...
export default function SettingsScreen() {
  ...
  const handleAdminLogin = () => {
    const usernameOk = loginInput.trim() === ADMIN_CREDENTIALS.username ||
                       loginInput.trim() === ADMIN_CREDENTIALS.email    ||
                       loginInput.trim() === ADMIN_CREDENTIALS.phone;
    const passwordOk = passInput === ADMIN_CREDENTIALS.password;
    ...
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.card}>
        <SettingRow
          ...
          iconColor="#a855f7"
          label="App Version"
          right={<Text style={styles.valueTxt}>v1.0.0</Text>}
        />
        <View style={styles.divider} />
        <SettingRow
          icon="person"
          iconColor="#22c55e"
          label="Developer"
          right={<Text style={styles.valueTxt}>MithunDas,11KHAN,JESSORE</Text>}
        />
        <View style={styles.divider} />
        <TouchableOpacity
        ...
        <View style={styles.overlay}>
          <View style={styles.loginCard}>
            ...
            <TextInput
              ...
              placeholder="mtx*** অথবা 01*** অথবা mtx***@gmail.com"
